...
class PSOOptimizationTracker:
    ...
    def plot_2d_curves_per_area(self, irrigation_system):
        ...
        ax1.set_title('梳齿状PSO算法优化迭代曲线 (单位面积成本)', fontproperties=chinese_font,
                      fontsize=chinese_size + 2)
        ...
        # 保存图表
        if self.auto_save:
            plt.savefig('PSO_DAN_2d_curves_per_area.png', dpi=300, bbox_inches='tight')
    ...
    def plot_3d_progress_per_area(self, irrigation_system):
        ...
        # 设置图表标题
        ax.set_title('梳齿状PSO算法优化3D进度图 (单位面积成本)', fontproperties=chinese_font, fontsize=chinese_size + 2)
        ...
        # 保存图表
        if self.auto_save:
            plt.savefig('PSO_DAN_3d_progress_per_area.png', dpi=300, bbox_inches='tight')
...
def visualize_pareto_front_per_area(pareto_front_particles, irrigation_system):
    ...
    try:
        ...
        plt.title('多目标梳齿PSO管网优化Pareto前沿 (单位面积成本)', fontproperties=chinese_font,
        ...
        # 保存图像
        plt.savefig('PSO_DAN_pareto_front_per_area.png', dpi=300, bbox_inches='tight')
