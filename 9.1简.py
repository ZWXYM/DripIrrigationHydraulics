...
def shuili(dripper_length, dripper_spacing, dripper_min_flow, fuzhu_sub_length, field_length, field_wide,
           Soil_bulk_density,
           field_z,
           field_p, field_max, field_min, sr, st, ib, nn, work_time, lgz0, lgz1, lgz2):
    ...
    T=t * (fuzhu_number/lgz0)*(32 / lgz1)*math.ceil(22/lgz2)/work_time
...
if __name__ == "__main__":
    ...
    shuili(50, 0.3, 2.1, 40, 100,
           200, 1.46, 600,
           0.7, 0.9, 0.8, 0.8, 0.1, 8, 0.9, 15, 1, 4, 12)
