...
class NSGAOptimizationTracker:
    ...
    def plot_2d_curves_per_area(self, irrigation_system):
        ...
        ax1.set_title('丰字NSGA-II算法优化迭代曲线 (单位面积成本)', fontproperties=chinese_font,
        ...
        # 保存图表
        if self.auto_save:
            plt.savefig('NSGA_SHUANG_2d_curves_per_area.png', dpi=300, bbox_inches='tight')
    ...
    def plot_3d_progress_per_area(self, irrigation_system):
        ...
        # 设置图表标题
        ax.set_title('丰字NSGA-II算法优化3D进度图 (单位面积成本)', fontproperties=chinese_font,
                     fontsize=chinese_size + 2)
        ...
        # 保存图表
        if self.auto_save:
            plt.savefig('NSGA_SHUANG_3d_progress_per_area.png', dpi=300, bbox_inches='tight')
...
def visualize_pareto_front_per_area(pareto_front, irrigation_system):
    ...
    try:
        ...
        # 保存图像
        plt.savefig('NSGA_SHUANG_pareto_front_per_area.png', dpi=300, bbox_inches='tight')
