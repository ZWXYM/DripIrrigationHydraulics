...
def multi_objective_pso(irrigation_system, lgz1, lgz2, swarm_size, max_iterations, show_plots,
    ...
    try:
        ...
        save_pareto_front(pareto_front_values, "PSO_SHUANG_Verified")
        save_pareto_solutions(verified_pareto_front, "PSO_SHUANG_Verified")
...
def save_pareto_front(pareto_front, algorithm_name, save_dir='PSO_SHUANG_result'):
    """
...
def save_pareto_solutions(solutions, algorithm_name, save_dir='PSO_SHUANG_result'):
    """
...
if __name__ == "__main__":
    ...
    # main_batch(32, 49.62, 500, 11, 2, 100, 50, False, True)
